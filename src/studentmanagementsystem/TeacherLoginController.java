...
public class TeacherLoginController implements Initializable {
    ...
    @FXML
    private void teacherRegister(ActionEvent event) throws IOException {
    ...
    private void onLogin(ActionEvent event) throws ClassNotFoundException, SQLException, IOException {
        ...
        if(pid.isEmpty()){
            ...
            PreparedStatement stmt = con.prepareStatement("SELECT * FROM teacher WHERE pid = ? and password = ?");
